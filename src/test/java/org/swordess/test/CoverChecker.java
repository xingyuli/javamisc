...
public class CoverChecker extends BlockJUnit4ClassRunner {
	...
	private void generateErrorMsg(
			...
			String signature,
			List<Integer> uncoveredValidECs,
			List<Integer> uncoveredInvalidECs,
			List<Integer> uncoveredBoundaries) {
		
		if (isNotEmpty(uncoveredValidECs) || isNotEmpty(uncoveredInvalidECs)
				|| isNotEmpty(uncoveredBoundaries)) {
